...
------
-- RegisterNetEvent RealWorldEffectSound:PlayOnOne
--
...
------
-- RegisterNetEvent RealWorldEffectSound:PlayOnAll
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
-- RegisterNetEvent RealWorldEffectSound:PlayWithinDistance
--
...
AddEventHandler(
    ...
    function(playerNetId, maxDistance, soundFile, soundVolume)
        ...
        if (distIs > 0 and distIs <= maxDistance) then
            SendNUIMessage(
                {
                    transactionType = "playSound",
                    transactionFile = soundFile,
