...
local blips = {
    ...
    {name=blipNameFuel, id=361, x=463.86, y=-1014.81, z=28.07},
    {name=blipNameFuel, id=361, x=336.63, y=-623.46, z=29.29},
    ...
    {name = blipNameFuelHeli, id=43,x=351.727,y=-588.052,z=74.165},
}
...
station = {
    ...
    {x=463.86, y=-1014.81, z=28.07, s=35},
    
    {x=336.63, y=-623.46, z=29.29, s=36}
}
...
heli_stations = {
    ...
    {x=351.727,y=-588.052,z=74.165,s=34}
}
...
stationsText[35] = {x=179.988,y=6602.996,z=33.918}
stationsText[36] = {x=-94.239,y=6419.58,z=32.615}
...
stationsText[34] = {x=351.72787475586,y=-588.05261230469,z=74.1656875610351}
--[[
================================================= FUNCTIONS =================================================
]]--
        ...
        for _, item in pairs(station) do
            ...
            if(near) then
                ...
                if(dist<100) then
               		...
               		DrawText3D(x,y,z, "~g~ " ..GetStreetNameFromHashKey(streetA).." "..GetStreetNameFromHashKey(streetB).." "..settings[lang].fuelStation.." ")
               		--DrawText3D(x,y,z-0.2, "~b~"..settings[lang].price.." 리터 당 "..StationsPrice[item.s].." ")
               		DrawText3D(x,y,z-0.2, "~b~리터 당 "..StationsPrice[item.s].." (소비세 포함) ")
               	end
            end
        end
