...
function spawnpet()
	...
	SetTimeout(
		...
		function()
			-- 5 secondes
			ped = CreatePed(RWP, 28, model, LastPosition.x + 1, LastPosition.y + 1, LastPosition.z - 1, 1, 1)
