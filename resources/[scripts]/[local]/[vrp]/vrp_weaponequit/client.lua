...
local txt = "행동" -- /me text
local bwtxt = "*자동차의 트렁크에서 무기를 가져옵니다.. *"
local dbtxt = "* 그 사람은 더플 백에서 무기를 가져 간다.. *"
local dbtxterr = "이 무기는 자동차 나 더플 가방에서만 꺼낼 수 있습니다.."
local bwtxterr = "이 무기는 차에서 밖에 가져갈 수 없습니다.."
local swtxt = "* 무기를 꺼냅니다.. *"
local mwtxt = "* 그 사람은 근접 무기를 꺼냅니다. *"
