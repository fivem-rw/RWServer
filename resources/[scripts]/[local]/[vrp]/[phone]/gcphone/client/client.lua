gcphoneC = {}
Tunnel.bindInterface("gcphone", gcphoneC)
Proxy.addInterface("gcphone", gcphoneC)
vRP = Proxy.getInterface("vRP")
gcphoneS = Tunnel.getInterface("gcphone", "gcphone")
        ...
        function(hasPhone)
          if hasPhone == true then
            ...
            if ShowNumberNotification == true then
              text = "~y~" .. message.transmitter .. "~o~로 부터 문자 도착"
              for _, contact in pairs(contacts) do
                if contact.number == message.transmitter then
                  text = "~g~" .. contact.display .. "~o~님으로 부터 문자 도착"
                  break
                end
              end
            end
...
function gcphoneC.promptResult(text)
  callback(json.encode({text = text}))
end
