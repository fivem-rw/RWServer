...
vRPclient = Tunnel.getInterface("vRP", "vrp_luckywheel")
vrp_luckywheelC = Tunnel.getInterface("vrp_luckywheel", "vrp_luckywheel")
Tunnel.bindInterface("vrp_luckywheel", vrp_luckywheelS)
            ...
            if user_id ~= nil then
                if vRP.getMoney({user_id}) >= amount then
                    ...
                    SetTimeout(
                        ...
                        function()
                            isRoll = false
                            vrp_luckywheelC.notify(_source, {"꽁짜라서 설렜지? 아쉽지만 준비중!~"})
                            --[[
                            -- Give Price
