...
local lang = vRP.lang
local cfg = module("cfg/admin_markets")
  ...
  if user_id ~= nil then
    for k, v in pairs(markets) do
      ...
      if group and menu then -- check market type
        ...
        vRPclient.addMarker(source, {x, y, z - 1, 1.2, 1.2, 0.2, 0, 255, 125, 125, 150, text})

        vRP.setArea(source, "vRP:admin_market" .. k, x, y, z, 0.6, 1.5, market_enter, market_leave)
      end
    end
  end
end
