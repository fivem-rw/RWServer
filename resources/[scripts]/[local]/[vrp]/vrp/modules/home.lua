...
MySQL.createCommand(
  "vRP/set_address",
  "REPLACE INTO vrp_user_homes(user_id,home,number) VALUES(@user_id,@home,@number)"
)
...
local function enter_slot(user_id, player, stype, sid) -- called when a player enter a slot
  ...
  menu[lang.home.slot.leave.title()] = {
    function(player, choice) -- add leave choice
  ...
  vRP.getUserAddress(
    ...
    function(address)
      ...
      if address ~= nil and address.home == slot.home_name and tostring(address.number) == slot.home_number then
        menu[lang.home.slot.ejectall.title()] = {
          function(player, choice) -- add eject all choice
          ...
          lang.home.slot.ejectall.description()
        }
      end
      ...
      for k, v in pairs(cfg.slot_types[stype][sid]) do
        ...
        if name == "entry" then
          ...
          local nid = "vRP:home:slot" .. stype .. sid
          vRPclient.setNamedMarker(player, {nid, x, y, z - 1, 1.5, 1.5, 0.2, 0, 255, 125, 125, 150})
...
local function build_entry_menu(user_id, home_name)
  ...
  menu[lang.home.intercom.title()] = {
    function(player, choice)
      vRP.prompt(
        player,
        lang.home.intercom.prompt(),
        "",
                  ...
                  if hplayer ~= nil then
                    vRP.prompt(
                      ...
                      function(player, who)
                        ...
                        vRP.request(
                          hplayer,
                          lang.home.intercom.request({who}),
                          30,
                          function(hplayer, ok)
                            if ok then
    ...
    lang.home.intercom.description()
  }

  menu[lang.home.buy.title()] = {
    function(player, choice)
      vRP.getUserAddress(
        user_id,
        function(address)
    ...
    lang.home.buy.description({home.buy_price})
  }

  menu[lang.home.sell.title()] = {
    function(player, choice)
      vRP.getUserAddress(
        user_id,
        function(address)
    ...
    lang.home.sell.description({home.sell_price})
  }
