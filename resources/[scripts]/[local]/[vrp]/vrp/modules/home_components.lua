    ...
    if user_id ~= nil and user_id == owner_id then
      ...
      vRP.getUData(
        ...
        function(data)
          ...
          -- save
          menu[lang.home.wardrobe.save.title()] = {
            function(player, choice)
              vRP.prompt(
                player,
                lang.home.wardrobe.save.prompt(),
                "",
...
local function gametable_create(owner_id, stype, sid, cid, config, x, y, z, player)
  local gametable_enter = function(player, area)
    ...
    if user_id ~= nil and user_id == owner_id then
      ...
      -- launch bet
      menu[lang.home.gametable.bet.title()] = {
        function(player, choice)
          vRP.prompt(
            player,
            lang.home.gametable.bet.prompt(),
            "",
                    ...
                    function(players)
                      ...
                      for k, v in pairs(players) do
                        ...
                        if nuser_id ~= nil then -- request
                          vRP.request(
                            nplayer,
                            lang.home.gametable.bet.request({amount}),
                            30,
                            function(nplayer, ok)
        ...
        lang.home.gametable.bet.description()
      }
