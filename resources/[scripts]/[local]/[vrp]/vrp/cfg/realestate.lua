...
cfg.realestate = {
  ...
  ["Club Sakura"] = {
    --slot = "trevor_trailer",
    entry_point = {-1389.2169189453, -623.30212402344, 30.819576263428},
    buy_price = 200000000,
    sell_price = 190000000,
    max = 1,
    blipid = 431,
    blipcolor = 1
  },
  ["Lindsay Circus LTD"] = {
    --slot = "trevor_trailer",
    entry_point = {-708.60290527344, -904.24041748047, 19.215587615967},
    buy_price = 120000000,
    sell_price = 110000000,
    max = 1,
    blipid = 431,
    blipcolor = 1
  },
  ["North Rockford RON"] = {
    --slot = "trevor_trailer",
    entry_point = {-1428.9851074219, -269.24945068359, 46.207695007324},
    buy_price = 60000000,
    sell_price = 50000000,
    max = 1,
    blipid = 431,
  ...
  ["V Club"] = {
    --slot = "trevor_trailer",
    entry_point = {-347.21502685547, 163.1180267334, 86.390678405762},
    buy_price = 180000000,
    sell_price = 160000000,
    max = 1,
    blipid = 431,
    blipcolor = 1
  },
  ["Richman Hotel"] = {
    --slot = "trevor_trailer",
    entry_point = {-1276.3050537109, 311.17932128906, 65.511772155762},
    buy_price = 500000000,
    sell_price = 490000000,
    max = 1,
    blipid = 431,
    blipcolor = 1
  },
  ...
  ["다이아몬드 카지노"] = {
    --slot = "trevor_trailer",
    entry_point = {929.62493896484, 47.960865020752, 81.123489379883},
    buy_price = 1200*100000000,
    sell_price = 600*100000000,
    max = 1,
    blipid = 431,
    blipcolor = 1
  },
  ["Vinewood Tattoo Shop"] = {
    --slot = "trevor_trailer",
    entry_point = {319.77133178711, 181.64451599121, 103.58648681641},
    buy_price = 20000000,
    sell_price = 15000000,
    max = 1,
    blipid = 431,
  ...
  ["Vanilla Unicorn"] = {
    --slot = "trevor_trailer",
    entry_point = {127.20325469971, -1284.9293212891, 29.281585693359},
    buy_price = 220000000,
    sell_price = 210000000,
    max = 1,
    blipid = 431,
    blipcolor = 1
  }
  ---347.21502685547,163.1180267334,86.390678405762
  ---1276.3050537109,311.17932128906,65.511772155762
  ]]
}
