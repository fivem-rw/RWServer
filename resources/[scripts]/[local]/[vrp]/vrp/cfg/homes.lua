...
local itemtr_study = {
  ...
  x = 0,
  y = 0,
  z = 0, -- pos (doesn't matter as home component)
  radius = 1.1,
  height = 1.5, -- area
  recipes = {
    ["Chemicals book"] = {
...
cfg.slot_types = {
  ...
  ["bunker"] = {
    {
      {"entry", 893.35034179688, -3245.6088867188, -98.259422302246},
      {"chest", 883.38165283203, -3202.6323242188, -98.196250915527, _config = {weight = 100000}},
      {"wardrobe", 907.85626220703, -3203.3347167969, -97.187950134277},
      {"gametable", 890.14489746094, -3202.6875, -98.196228027344}
      --{"itemtr", _config = itemtr_study, -1156.6875,-1517.3475341797,10.632729530334}
    }
  },
  ["alone_island_2"] = {
    {
      {"entry", 2845.1625976563, -739.31939697266, 6.2440714836121},
      {"chest", 2852.0966796875, -755.7451171875, 6.3465666770935, _config = {weight = 200}},
      {"wardrobe", 2841.5715332031, -757.60662841797, 6.3465671539307},
      {"gametable", 2852.9291992188, -743.66741943359, 6.3065629005432}
      --{"itemtr", _config = itemtr_study, -1156.6875,-1517.3475341797,10.632729530334}
    }
  },
  ["alone_island"] = {
    {
      {"entry", -5864.7236328125, 1151.2410888672, 7.9999976158142},
      {"chest", -5866.7944335938, 1146.8581542969, 13.196558952332, _config = {weight = 200}},
      {"wardrobe", -5863.4194335938, 1142.3797607422, 13.260005950928},
      {"gametable", -5868.9418945313, 1145.3791503906, 8.0365676879883}
      --{"itemtr", _config = itemtr_study, -1156.6875,-1517.3475341797,10.632729530334}
    }
  },
  ["trevor_trailer"] = {
  ...
  ["arcadius"] = {
    {
      {"entry", -141.09234619141, -614.78552246094, 168.82052612305},
      {"chest", -125.28276824951, -638.87829589844, 168.82041931152, _config = {weight = 500}},
      {"wardrobe", -131.61505126953, -634.7958984375, 168.82051086426},
      {"gametable", -137.71943664551, -643.79888916016, 168.82614135742}
    }
  },
  ["lombank"] = {
    {
      {"entry", -1582.5656738281, -559.11932373047, 108.52292633057},
      {"chest", -1555.8724365234, -572.85968017578, 108.53784179688, _config = {weight = 500}},
      {"wardrobe", -1565.5697021484, -570.68280029297, 108.52291107178},
      {"gametable", -1565.0336914063, -583.02349853516, 108.53787994385}
    }
  },
  ["penthouse"] = {
    {
      {"entry", 980.01, 57.01, 116.16},
      {"chest", 961.28, 25.45, 116.16, _config = {weight = 500}},
      {"wardrobe", 975.36, 65.22, 116.16},
      {"gametable", 963.3, 48.96, 116.18}
    }
  },
  ["mazeoffice"] = {
    {
      {"entry", -78.993019104004, -833.12811279297, 243.38597106934},
      {"chest", -82.649261474609, -803.73687744141, 243.38597106934, _config = {weight = 500}},
      {"wardrobe", -79.106887817383, -811.20483398438, 243.38594055176},
      {"gametable", -68.782035827637, -804.89044189453, 243.39157104492}
    }
  }
}
...
cfg.homes = {
  ...
  ["벙커"] = {
    slot = "bunker",
    entry_point = {898.63104248047, -3245.6779785156, -98.114738464355},
  ...
  ["리얼월드 섬"] = {
    slot = "alone_island",
    entry_point = {-5860.7641601563, 1151.3997802734, 7.9800019264221},
    buy_price = 99999999999,
    sell_price = 0,
    max = 1,
    blipid = 455,
  ...
  ["리얼월드 두번째섬"] = {
    slot = "alone_island_2",
    entry_point = {2828.5625, -710.74517822266, 2.4534056186676},
    buy_price = 99999999999,
    sell_price = 0,
    max = 1,
    blipid = 455,
  ...
  ["비즈니스 센터"] = {
    slot = "arcadius",
    entry_point = {-115.21582794189, -604.77819824219, 36.280715942383},
    buy_price = 40000000,
    sell_price = 30000000,
    max = 1,
    blipid = 374,
  ...
  ["롬 뱅크 빌딩"] = {
    slot = "lombank",
    entry_point = {-1581.7244873047, -557.86267089844, 34.952865600586},
  ...
  ["펜트 하우스"] = {
    slot = "penthouse",
    entry_point = {1085.28, 221.95, -49.2},
  ...
  ["메이즈뱅크 빌딩"] = {
    slot = "mazeoffice",
    entry_point = {-66.21019744873, -801.40515136719, 44.227291107178},
    buy_price = 50000000,
    sell_price = 30000000,
    max = 1,
    blipid = 374,
