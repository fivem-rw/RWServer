...
function vRPpm.setConeOnGround()
  ...
  local object = CreateObject(RWO, cone, ox, oy, oz, true, true, false)
...
function vRPpm.setBarrierOnGround()
  ...
  local object = CreateObject(RWO, barrier, ox, oy, oz, true, true, false)
  PlaceObjectOnGroundProperly(object)
  SetEntityHeading(object, h + 90)
end
...
function vRPpm.setBarrierWorkOnGround()
  ...
  local object = CreateObject(RWO, barrier2, ox, oy, oz, true, true, false)
  PlaceObjectOnGroundProperly(object)
  SetEntityHeading(object, h + 90)
end
...
function vRPpm.setSpikesOnGround()
  ...
  local object = CreateObject(RWO, spike, ox, oy, oz, true, true, false)
  PlaceObjectOnGroundProperly(object)
  SetEntityHeading(object, h + 90)
end
