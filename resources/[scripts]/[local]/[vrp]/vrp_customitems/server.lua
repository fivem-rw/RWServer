...
vRPclient = Tunnel.getInterface("vRP","vrp_customitems")
Dclient = Tunnel.getInterface("vrp_customitems","vrp_customitems")
Tunnel.bindInterface("vrp_customitems",vRPd)

local cfg = module("vrp_customitems", "cfg/drugs")
