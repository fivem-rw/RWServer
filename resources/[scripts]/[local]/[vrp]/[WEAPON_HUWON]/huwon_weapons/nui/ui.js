...
$( function() {
    ...
    var actionContainer = $( "#action_huwon_menu" );
...
function init() {
    ...
    $( "#action_huwon_menu" ).children( "div" ).each( function( i, obj ) {
...
function sendData( name, data ) {
    $.post( "http://huwon_weapons/" + name, JSON.stringify( data ), function( datab ) {
        if ( datab != "ok" ) {
            console.log( datab );
        }            
    } );
