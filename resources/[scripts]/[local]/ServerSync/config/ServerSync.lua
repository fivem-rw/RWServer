...
ss_weather_Transition = {
    ...
    ["RAIN"] = {"RAIN", "SMOG", "RAIN", "OVERCAST"},
    ["THUNDER"] = {"OVERCAST"}, -- Always rotate away from Thunder, as it's annoying
    ["CLEARING"] = {"CLEAR", "CLOUDS", "OVERCAST", "SMOG"},
    ["SNOW"] = {"SNOW"}, -- Usually used for events - never changes and has to be manually set via /weather command
    ["SNOWLIGHT"] = {"SNOW", "SNOWLIGHT"}, -- Usually used for events - never changes and has to be manually set via /weather command
    ["BLIZZARD"] = {"BLIZZARD", "THUNDER", "OVERCAST", "SMOG"}, -- Usually used for events - never changes and has to be manually set via /weather command
...
ss_wind_speed_Mult = {
    ...
    ["BLIZZARD"] = 10.8 * ss_wind_speed_max,
