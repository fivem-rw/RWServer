...
SecurityCamConfig.Locations = {
    {
        camBox = {label = "보호구역", x = 440.33, y = -975.71, z = 30.68},
        cameras = {
            ...
            {label = "Jail 1", x = 1645.34, y = 2573.81, z = 48.91, r = {x = -30.0, y = 0.0, z = 140.29}, canRotate = true},
            {label = "Jail 2", x = 1638.99, y = 2566.69, z = 49.59, r = {x = -30.0, y = 0.0, z = -40.50}, canRotate = true}
        },
        allowedModels = {}
    }
}
